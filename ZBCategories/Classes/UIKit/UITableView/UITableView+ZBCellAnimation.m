...
#import "UITableView+ZBCellAnimation.h"
#define UI_SCREEN_WIDTH [[UIScreen mainScreen] bounds].size.width
#define UI_SCREEN_HEIGHT [[UIScreen mainScreen] bounds].size.height
@implementation UITableView (ZBCellAnimation)
...
- (void)addFallAnimation
{
    ...
    for (int i = 0; i < cells.count; i++) {
        UITableViewCell *cell = [self.visibleCells objectAtIndex:i];
        cell.transform = CGAffineTransformMakeTranslation(0, - UI_SCREEN_HEIGHT);
...
- (void)addSpringListAnimation
{
    ...
    for (int i = 0; i < cells.count; i++) {
        ...
        cell.layer.transform = CATransform3DMakeTranslation(0, -UI_SCREEN_HEIGHT, 20);
